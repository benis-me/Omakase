import { Bot, Brain, FileText, ListTree, TerminalSquare, Workflow, type LucideIcon } from 'lucide-react';
...
export const NAV_SECTIONS: readonly NavItem[] = [
  ...
  { id: 'agents', label: 'Agents', icon: Bot, hint: 'Agent definitions and detection' },
